Public Class FormRopa
    ...
    Public Sub asignacionPrecio(precio1 As Integer, precio2 As Integer, precio3 As Integer, precio4 As Integer, precio5 As Integer)
    ...
    'Procedimiento solo para estetica
    Public Sub visibilidad()
        gpxRopa.Visible = True
        ...
        Select Case cmbClasificacion.SelectedIndex
            Case 0
                If rbHombre.Checked = True Then
                    ...
                    asignacionPrecio(200, 220, 240, 260, 280)
                Else
                    ...
                    asignacionPrecio(300, 330, 360, 390, 410)
                End If
            Case 1
                If rbHombre.Checked = True Then
                    ...
                    asignacionPrecio(680, 700, 800, 820, 500)
                Else
                    ...
                    asignacionPrecio(1500, 4000, 2000, 2500, 1900)
                End If
            Case 2
                If rbHombre.Checked = True Then
                    ...
                    asignacionPrecio(345, 200, 250, 220, 150)
                Else
                    ...
                    asignacionPrecio(124, 199, 79, 895, 1395)
                End If
        End Select
    End Sub
    ...
    Private Sub FormRopa_Load(sender As Object, e As EventArgs) Handles MyBase.Load
        pbBanner.Location = New Point(237, 42)
        Me.Size = New Size(840, 333)
    End Sub
End Class